...
- [Reflected XSS](/Notes/Web/2022-09-11-Common_Web_Attacks#Reflected_XSS), where the malicious script comes from the current HTTP request.
- [Stored XSS](/Notes/Web/2022-09-11-Common_Web_Attacks#Stored_XSS), where the malicious script comes from the website's database.
- [DOM-based XSS](](/Notes/Web/2022-09-11-Common_Web_Attacks#DOM-based_XSS), where the vulnerability exists in client-side code rather than server-side code.
